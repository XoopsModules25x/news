<div class="news-article">
    ...
    <div class="marg2 pad2"><{include file="db:news_item.tpl" story=$story}>
        ...
        <{if $showicons === true}>
            <a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/print.php?storyid=<{$story.id}>" rel="nofollow"
        ...
        <{/if}>
        <{if $showPdfIcon === true}>
            <a target="_blank" href="<{$xoops_url}>/modules/<{$xoops_dirname}>/makepdf.php?storyid=<{$story.id}>" rel="nofollow"
        ...
        <div class="item-bookmarkme">
            ...
            <div class="item-bookmarkme-items">
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_BLINKLIST}>"
                   href="https://www.blinklist.com/index.php?Action=Blink/addblink.php&Description=&Url=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>&Title=<{$story.news_title}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_DELICIOUS}>"
                   href="https://del.icio.us/post?url=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>&title=<{$story.news_title}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_DIGG}>"
                   href="https://digg.com/submit?phase=2&url=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_FARK}>"
                   href="https://cgi.fark.com/cgi/fark/edit.pl?new_url=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>&new_comment=<{$story.news_title}>&new_link_other=<{$story.news_title}>&linktype=Misc"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_FURL}>"
                   href="https://www.furl.net/storeIt.jsp?t=<{$story.news_title}>&u=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_NEWSVINE}>"
                   href="https://www.nwvine.com/_tools/seed&save?u=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>&h=<{$story.news_title}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_REDDIT}>"
                   href="https://reddit.com/submit?url=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>&title=<{$story.news_title}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_SIMPY}>"
                   href="https://www.simpy.com/simpy/LinkAdd.do?href=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>&title=<{$story.news_title}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_SPURL}>"
                   href="https://www.spurl.net/spurl.php?title=<{$story.news_title}>&url=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_YAHOO}>"
                   href="https://myweb2.search.yahoo.com/myresults/bookmarklet?t=<{$story.news_title}>&u=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_BALATARIN}>"
                   href="https://balatarin.com/links/submit?phase=2&amp;url=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_FACEBOOK}>"
                   href="https://www.facebook.com/share.php?u=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_TWITTER}>"
                   href="https://twitter.com/home?status=Browsing:%20<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_SCRIPSTYLE}>"
                   href="https://scriptandstyle.com/submit?url=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_STUMBLE}>"
                   href="https://www.stumbleupon.com/submit?url=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_TECHNORATI}>"
                   href="https://technorati.com/faves?add=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_MIXX}>"
                   href="https://www.mixx.com/submit?page_url=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_MYSPACE}>"
                   href="https://www.myspace.com/Modules/PostTo/Pages/?u=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_DESIGNFLOAT}>"
                   href="https://www.designfloat.com/submit.php?url=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_GOOGLEPLUS}>"
                   href="https://plusone.google.com/_/+1/confirm?hl=en&url=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_GOOGLEREADER}>"
                   href="https://www.google.com/reader/link?url=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>&amp;title=<{$story.news_title}>"><img
                ...
                <a rel="external nofollow" target="_blank" title="<{$smarty.const._NW_BOOKMARK_TO_GOOGLEBOOKMARKS}>"
                   href="https://www.google.com/bookmarks/mark?op=add&amp;bkmk=<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>&amp;title=<{$story.news_title}>"><img
            ...
            <ul>
                <li>
                    <div class="item-bookmarkme-facebook">
                        ...
                        <fb:like href="<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>"
                ...
                <li>
                    <div class="item-bookmarkme-twitter">
                        ...
                        <a href="https://twitter.com/share/<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>"
    ...
    <{if $fbcomments === true}>
        <div id="fb-root"></div>
        <script src="https://connect.facebook.net/en_US/all.js#xfbml=1"></script>
        <fb:comments href="<{$xoops_url}>/modules/<{$xoops_dirname}>/article.php?storyid=<{$story.id}>" num_posts="5"
